...
if (!function_exists('elessi_checkout_get_coupon_slide')) :
    function elessi_checkout_get_coupon_slide() {
        ...
        if (!empty($publish_couponts)) : 
            ...
            $arr_attrs = apply_filters('elessi_attrs_coupon_wrap', $data_attrs);
            ...
            <div class="publish-coupons publish-coupons-slide  nasa-slick-nav nasa-nav-top nasa-slick-slider"<?php echo $attrs_str; ?>>
                ...
                ?>
                    <span class="publish-coupon-wrap">
                        <a href="javascript:void(0);" data-code="<?php echo esc_attr($code); ?>" class="publish-coupon<?php echo in_array($code, $coupons_used) ? ' nasa-added nasa-active' : '' ?>" title="<?php echo esc_attr__('Click here to Apply this coupon.', 'elessi-theme'); ?>">
                            <span class="discount-info nasa-bold fs-14"><?php echo $discount_lbl; ?></span>
                            <span class="nasa-bold discount-code fs-13 nasa-uppercase"><?php echo $code; ?></span>
                            <span class="discount-exp fs-13"><?php echo $date_expires_lbl; ?></span>
                        </a>
                    </span>
                <?php endforeach; ?>
            </div>
