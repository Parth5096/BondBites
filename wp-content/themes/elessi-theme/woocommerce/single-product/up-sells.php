...
if ($upsells) :
    ...
    <div class="row related-product nasa-slider-wrap related up-sell products grid nasa-relative mobile-margin-bottom-20<?php echo $ex_class;?>">
        <div class="large-12 columns">
            <h3 class="nasa-title-relate<?php echo $head_class;?>">
