...
defined('NASA_VERSION') or define('NASA_VERSION', '6.3.1');
 ...
 * Languages
 */
add_action('after_setup_theme', 'elessi_load_textdomain');
if (!function_exists('elessi_load_textdomain')) :
    function elessi_load_textdomain() {
        /**
