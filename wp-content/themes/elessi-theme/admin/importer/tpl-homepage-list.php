...
<div class="ns-homes-search nasa-flex jc">
    <div class="ns-homes-search-wrap">
        ...
        <label class="ns-label-search" for="ns-homes-search-input"><svg viewBox="0 0 80 80" width="26" height="26" fill="currentColor">
    ...
    <div class="nasa-tabs-panel">
        <?php if ($wpb_home) : ?>
            ...
            <div class="demo-homepages-wrap demo-homepages-wpb nasa-tab-content tab-content-js_composer">
                ...
                <div class="demo-homepage-item-wrap">
                    <a href="javascript:void(0);" data-home="drone-1" class="demo-homepage-item">
                        <div class="img-wrap">
                            <img src="<?php echo ELESSI_THEME_URI; ?>/admin/assets/pages/drone-v1.jpg" alt="Drone v1" />
                        </div>

                        <h4 class="home-title">Drone <sup>v1</sup></h4>
                    </a>
                </div>

                <div class="demo-homepage-item-wrap">
                    <a href="javascript:void(0);" data-home="toys-1" class="demo-homepage-item">
                        <div class="img-wrap">
                            <img src="<?php echo ELESSI_THEME_URI; ?>/admin/assets/pages/toy-demo.jpg" alt="Toys v1" />
                        </div>

                        <h4 class="home-title">Toys <sup>v1</sup></h4>
                    </a>
                </div>
