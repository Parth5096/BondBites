...
[/vc_column_text][nasa_image link_text="#" image="' . $imgs_1 . '" el_class="skip-lazy margin-top-20 max-w250"][/vc_column_inner][/vc_row_inner][/vc_column][/vc_row][vc_row el_class="padding-top-25 padding-bottom-25" css=".vc_custom_1734341936115 {border-top-width: 1px !important;border-top-style: solid !important;border-color: #EFEFEF !important;}"][vc_column width="1/2"][vc_column_text css=""]© 2024 <strong>Nasatheme</strong> - All Right reserved![/vc_column_text][/vc_column][vc_column width="1/2"][nasa_image alt="Visa Trust" link_text="#" image="' . $imgs_2 . '" align="right" hide_in_m="1"][/vc_column][/vc_row]'
        ),
        'post_meta' => array(
