...
class Elessi_DF_Page_Importer {
    ...
    public static function nasa_wpb_default_page() {
        ...
        $post_meta = array(
            ...
            '_nasa_btn_text_color_flag' => '',
            '_nasa_btn_text_color' => '',
    ...
    /**
     * Default page WPB Static Block
     * 
     * @global type $nasa_current_user_id
     * @return type
     */
    public static function nasa_wpb_default_stblock() {
        global $nasa_current_user_id;
        ...
        $post_default = array(
            ...
            'post_date_gmt' => $time_now,
            'post_content' => '',
            'post_title' => 'WPB - Title Block',
            'post_excerpt' => '',
            'post_status' => 'publish',
            'comment_status' => 'closed',
            'ping_status' => 'closed',
            'post_password' => '',
            'post_name' => 'WPB - Slug Block',
            'to_ping' => '',
            'pinged' => '',
            'post_modified' => $time_now,
            'post_modified_gmt' => $time_now,
    ...
    public static function nasa_render_page_data($type, $data) {
        if (!in_array($type, array('wpb', 'elm', 'hfe', 'hfe-header', 'footer', 'ctblock', 'stblock'))) {
            return null;
        }
        ...
        switch ($type) {
            ...
            case 'stblock':
                $default_data = self::nasa_wpb_default_stblock();
                break;
        } 
     ...
     * @return boolean
     */
    public static function nasa_wpb_stblock_data($stblock) {
        $file = ELESSI_ADMIN_PATH . 'importer/data-import/st-block-wp/nasa_' . $stblock . '.php';
        if (!is_file($file)) {
            return false;
        }
        ...
        return call_user_func('nasa_wpb_' . str_replace('-', '_', $stblock));
    }
    ...
    public static function nasa_push_data_from_file($type = '', $page = '', $home = false) {
        ...
        switch ($type) {
            ...
            case 'stblock':
                $data = self::nasa_wpb_stblock_data($page);
                break;    
        } 
