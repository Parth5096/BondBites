                ...
                <div class="nasa-blog-info nasa-blog-img-top <?php echo esc_attr($class_info_reverse); ?>">
                    <div class="nasa-blog-info-wrap info-wrap">
                        ...
                        <div class="nasa-date-author-wrap nasa-post-date-author-wrap nasa-flex flex-wrap <?php echo esc_attr($class_reverse_au_date); ?>">
                                ...
                                <a href="<?php echo esc_url($link_date); ?>" title="<?php echo esc_html__('Posts at ', 'nasa-core') . esc_attr($date_post); ?>" class="nasa-post-date-author-link">
                                    <span class="nasa-post-date-author nasa-iflex">
                                        <svg class="margin-right-5 rtl-margin-right-0 rtl-margin-left-5" width="18" height="18" viewBox="0 0 32 32" fill="currentColor">
                                            ...
                                            <path d="M11.201 5.871h1.6v1.599h-1.6v-1.599z" />
                            ...
                            <?php if ($readmore == 'yes') : ?>
                                <a href="<?php echo esc_url($link); ?>" title="<?php echo esc_html__('Read more', 'nasa-core'); ?>" class="nasa-post-date-author-link nasa-post-read-more">
                                    <span class="nasa-post-date-author nasa-iflex">
                                        <svg class="margin-right-5 rtl-margin-right-0 rtl-margin-left-5" width="15" height="18" viewBox="0 0 32 32" fill="currentColor">
