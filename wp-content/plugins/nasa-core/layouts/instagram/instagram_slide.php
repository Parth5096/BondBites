...
echo '<div class="' . esc_attr($ulclass) . '" data-columns="' . $columns_number . '" data-columns-small="' . $columns_number_small . '" data-columns-tablet="' . $columns_number_tablet . '" data-autoplay="' . esc_attr($auto_slide) . '" data-loop="' . esc_attr($loop_slide) . '" data-switch-tablet="' . nasa_switch_tablet() . '" data-switch-desktop="' . nasa_switch_desktop() . '">';
