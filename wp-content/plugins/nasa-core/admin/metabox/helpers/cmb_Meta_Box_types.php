...
class cmb_Meta_Box_types {
    ...
    public function _desc($paragraph = false, $echo = false) {
        ...
        $desc = '<' . $tag . ' class="cmb_metabox_description">' . $this->field->args('description') . '</' . $tag . '>';
            ...
            foreach ($meta_value as $id => $fullurl) {
                ...
                if ($this->is_valid_img_ext($fullurl)) {
                    ...
                    '<li class="img_status">' .
                        ...
                        '<p class="cmb_remove_wrapper"><a href="#" class="cmb_remove_file_button">' . esc_html__('Remove Image', 'nasa-core') . '</a></p>' . $id_input .
                    '</li>';
                } else {
                    ...
                    echo
                    '<li>' .
                        esc_html__('File:', 'nasa-core') . ' <strong>' . $title . '</strong>&nbsp;&nbsp;&nbsp; (<a href="' . $fullurl . '" target="_blank" rel="external">' . esc_html__('Download', 'nasa-core') . '</a> / <a href="#" class="cmb_remove_file_button">' . esc_html__('Remove', 'nasa-core') . '</a>)' . $id_input .
                    '</li>';
                }
            }
        }
    ...
    public function file() {
        ...
        '<input class="cmb_upload_button button" type="button" value="' . esc_attr__('Add or Upload File', 'nasa-core') . '" />',
        $this->_desc(true);
