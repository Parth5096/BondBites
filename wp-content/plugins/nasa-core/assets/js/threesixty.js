        ...
        base.showNavigation = function () {
            if (AppConfig.navigation && !AppConfig.navigation_init) {
                ...
                next = $('<a/>').attr({
                    'href': '#',
                    'class': 'nav_bar_next'
                }).html('<svg width="42" height="45" viewBox="0 0 32 32" fill="currentColor"><path d="M19.159 16.767l0.754-0.754-6.035-6.035-0.754 0.754 5.281 5.281-5.256 5.256 0.754 0.754 3.013-3.013z" /></svg>');

                previous = $('<a/>').attr({
                    'href': '#',
                    'class': 'nav_bar_previous'
                }).html('<svg width="42" height="45" viewBox="0 0 32 32" fill="currentColor"><path d="M12.792 15.233l-0.754 0.754 6.035 6.035 0.754-0.754-5.281-5.281 5.256-5.256-0.754-0.754-3.013 3.013z" /></svg>');
        ...
        base.responsive = function () {
            if (AppConfig.responsive) {
                base.$el.css({
                    ...
                    width: base.$el.find('.current-image').first().css('width'),
                });
            }
        };
...
jQuery(document).ready(function ($) {
    ...
    $('body').on('click', '.nasa-360-degree-popup', function () {
        ...
        var _popup_360 = $('.nasa-product-360-degree');

        $(_popup_360).addClass('ns-360-degree-ready');
        
        setTimeout(function(){
            $(_popup_360).addClass('ns-actived');
        },20);
     ...
     * 360 Degree Close
     */
    $('body').on('click', '.close-360-degree', function () {
        var _popup_360 = $('.nasa-product-360-degree');
        $(_popup_360).addClass('ns-removing');

        $('.black-window').fadeOut(400).removeClass('desk-window');
        $('body').removeClass('ovhd');
    
        setTimeout(function() {
            $(_popup_360).removeClass('ns-actived ns-removing ns-360-degree-ready');
        },400);
    ...
    $('body').on('nasa_before_popup_360_degree', function() {
        if ($('#nasa-360-degree').length && $('.nasa-product-360-degree').find('.nasa-threesixty').length <= 0) {
            var _imgArr = [];
            ...
            if (_imgArr.length) {
                ...
                if ($('.nasa-threesixty-wrap').length <= 0) {
                    $('.nasa-product-360-degree').append(
                            ...
                            '<a class="nasa-stclose close-360-degree" href="javascript:void(0);"></a>'+
                            '<div class="spinner">' +
                            '<span>0%</span>' +
                            '</div>' +
